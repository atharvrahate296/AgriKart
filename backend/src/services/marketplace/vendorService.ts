  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .update({
        ...
        ...(input.business_name && { company_name: input.business_name }),
        ...
        ...(input.registration_number && { registration_number: input.registration_number }),
        ...(input.gst_number && { gst_number: input.gst_number }),
        ...(input.pan_number && { pan_number: input.pan_number }),
        ...(input.business_phone && { business_phone: input.business_phone, phone_business: input.business_phone }),
        ...(input.business_email !== undefined && { business_email: input.business_email || null }),
        ...(input.business_address && { business_address: input.business_address, location: input.business_address }),
        ...(input.city && { city: input.city }),
        ...(input.state && { state: input.state }),
        ...(input.pincode && { pincode: input.pincode }),
        ...(input.website_url !== undefined && { website_url: input.website_url || null }),
        ...(input.years_in_business !== undefined && { years_in_business: input.years_in_business }),
        ...(input.service_areas && { service_areas: input.service_areas }),
        ...(input.support_contact && { support_contact: input.support_contact }),
